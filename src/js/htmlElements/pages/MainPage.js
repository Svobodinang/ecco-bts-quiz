...
export default class MainPage extends HtmlElement {
    ...
    appendTitleImg() {
        ...
        this.children.subtitle = new HtmlElement({ parentEl: this.el, tag: 'p', innerHTML: 'Давай вспомним как это было? Любимый предмет, первый медленный танец, классные друзья на&nbsp;всю жизнь. Поделись своими школьными воспоминаниями и&nbsp;получи 3000 бонусов от&nbsp;ЕССО' });
